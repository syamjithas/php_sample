<?php
// echo '<link rel="stylesheet" href="' . urlBase() . '/css/filepond.css">';
// echo '<link rel="stylesheet" href="' . urlBase() . '/lib/filepond/css/normalize.min.css">';
echo '<link rel="stylesheet" href="' . urlBase() . '/lib/filepond/css/filepond-plugin-image-preview.min.css">';

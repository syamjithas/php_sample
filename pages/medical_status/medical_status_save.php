...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  try {
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      bp_mm = '{$data['bp_mm']}',bp_hg = '{$data['bp_hg']}',habits_cigarette = '{$data['habits_cigarette']}',tobacco_snuff = '{$data['tobacco_snuff']}',
      ...
      $sql = "INSERT INTO hie_db.medical_status (aadhaar_num,height,weight,pulse,bp_mm,bp_hg,habits_cigarette,
      ...
      '{$data['habits_cigarette']}', '{$data['tobacco_snuff']}', '{$data['alcohol']}','{$data['diabetes']}', 
